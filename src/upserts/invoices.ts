...
export async function upsertInvoice(
  ...
  const row = {
    ...
    amountOverpaid: inv.amount_overpaid,
    amountPaid: inv.amount_paid,
    amountPaidOffStripe: inv.amount_paid_off_stripe ?? null,
    ...
    automaticallyFinalizesAt: inv.automatically_finalizes_at ?? null,
    ...
    customer: customerId,
    customerAccount: inv.customer_account ?? null,
    ...
    totalPretaxCreditAmounts: inv.total_pretax_credit_amounts ?? null,
    totalTaxes: inv.total_taxes ?? null,
  ...
  await db.insert(invoices).values(row).onConflictDoUpdate({
    ...
    set: {
      ...
      amountOverpaid: sql`excluded.amount_overpaid`,
      amountPaid: sql`excluded.amount_paid`,
      amountPaidOffStripe: sql`excluded.amount_paid_off_stripe`,
      ...
      automaticallyFinalizesAt: sql`excluded.automatically_finalizes_at`,
      ...
      customerAccount: sql`excluded.customer_account`,
      ...
      totalPretaxCreditAmounts: sql`excluded.total_pretax_credit_amounts`,
